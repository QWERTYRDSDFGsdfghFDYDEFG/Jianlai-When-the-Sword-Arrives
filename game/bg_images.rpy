...
# Temporary prologue placeholders so chapter 1 can be tested end-to-end
# before the remaining painted backgrounds are imported.
image bg c1_03_lh_entry_v1 = im.Scale("images/chapter1/c1_02_midnight_lake_v1.png", 1920, 1080)
